...
function getItems(location: string) {
    return [
        ...
        {
            title: 'Expert Construction Cleaners',
        ...
        },
        {
            ...
            content: `We’ve got insured & vetted after builder cleaners across ${location}, ready to help get you in getting your home sparkling clean.`,
        },
        {
